...
import com.oss.front.FIndexController;
import com.oss.global.BaseMetaObjectIntercept;
import com.oss.global.GlobalEovaIntercept;
import com.oss.model._MappingKit;
import com.oss.news.NewsController;
import com.oss.note.NoteController;
import com.oss.strategy.StrategyController;
...
public class OSSConfig extends EovaConfig {
	...
	protected void route(Routes me) {
		...
		me.add("/fIndex",FIndexController.class,"/travel/views/");
        me.add("/strategy",StrategyController.class,"/travel/views/strategy/");
        me.add("/news",NewsController.class,"/travel/views/news/");
        me.add("/note",NoteController.class,"/travel/views/note/");
		...
		LoginInterceptor.excludes.add("/fIndex/**");
